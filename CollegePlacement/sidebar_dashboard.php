<div class="span3" id="sidebar">
	<img id="avatar" class="img-polaroid" src="nehadmin/<?php echo $row['location']; ?>">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        ...
        <li class="active"><a href="Student-List"><i class="icon-chevron-right"></i><i class="icon-envelope-alt"></i>&nbsp;Students</a></li> 
...
<li ><a href="MyShare"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;My Share</a></li>
