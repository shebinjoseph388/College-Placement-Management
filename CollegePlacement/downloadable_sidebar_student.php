				      ...
				      <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-plus-sign"></i> Register for Placement</h4></div>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="desc" Placeholder="company"  class="input" required>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">

                                <button name="Upload" type="submit" value="Upload" class="btn btn-info" /><i class="icon-upload-alt"></i>&nbsp;Register</button>
                            </div>
                        </div>
                    </form>
				...
				$("#add_downloadble").submit(function(e){
					...
					$.ajax({
						...
						success: function(html){
							...
							window.location = 'Student-Downloadable-Materials<?php echo '?id='.$get_id; ?>';
						},
						cache: false,
						contentType: false,
						processData: false
