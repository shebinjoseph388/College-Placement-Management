 ...
 include('dbcon.php'); ?>
	...
	$query = mysql_query("select * from student LEFT JOIN class ON student.class_id = class.class_id where status = 'Unregistered' and student.class_id='$class' ORDER BY student.student_id DESC") or die(mysql_error());
