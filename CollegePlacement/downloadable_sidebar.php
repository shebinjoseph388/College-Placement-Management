				      ...
				      <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-plus-sign"></i> New Placement</h4></div>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="name" Placeholder="Company Name"  class="input" required>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <button name="Upload" type="submit" value="Upload" class="btn btn-info" /><i class="icon-upload-alt"></i>&nbsp;Submit</button>
                            </div>
                        </div>
                    </form>
