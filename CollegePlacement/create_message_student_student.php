                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								    ...
								    <ul class="nav nav-tabs">
										<li>
											<a href="Mssages-Student">To Executive</a>
										</li>
										<li class="active"><a href="student_message_student.php">For Admin</a></li>
												...
												<script>
															...
															jQuery("#send_message_student").submit(function(e){
																	...
																	$.ajax({
																		...
																		var delay = 2000;
																			setTimeout(function(){ window.location = 'Mssages-Student'  }, delay);  
																		}
																	});
																	return false;
																});
