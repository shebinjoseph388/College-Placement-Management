                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="Aptitude-Exam" class="btn btn-success"><i class="icon-arrow-left"></i> Back</a>
									<a href="Add-Question-Exam<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-plus-sign"></i> Add Question</a>
									</div>
									...
									?>                              
										...
										<td width="30">
											<input id="optionsCheckbox" class="" name="selector[]" type="checkbox" value="<?php echo $id; ?>">
												...
												<td width="30"><a href="Edit-Question-Exam<?php echo '?id='.$get_id; ?>&<?php echo 'quiz_question_id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>                                      
										</tr>
									<?php } ?>
										</tbody>
									</table>
