...
<?php 
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li ><a href="Placement-Details"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;PlacementForms</a></li>
         <li class=""><a href="Aptitude-Exam"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Exam</a></li>
          <li class="active"><a href="MyShare"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;My Share</a></li>
