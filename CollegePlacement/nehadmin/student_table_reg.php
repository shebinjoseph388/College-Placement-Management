	...
	while ($row = mysql_fetch_array($query)) {
		$id = $row['student_id'];$count=$row['count'];
		?>
		...
		<td width="30"><a href="Admin-Edit-Student-Lists<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i> </a></td><?php if ($count <3 ){ ?>
