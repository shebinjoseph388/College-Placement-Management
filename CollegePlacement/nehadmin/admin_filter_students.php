...
<?php 
	  ...
	  ?>
		<script>
		window.location = "Admin-Announced-Placements<?php echo '?id='.$get_id; ?>";
		</script>
	  <?php
	  }
	
 ?>
    <body id="class_div" style = "background-image:url(images/index.jpg);">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								<?php
								$year_query = mysql_query("select * from class where class_id='$get_id' ")or die(mysql_error());
				...
				$id = $row1['class_id'];
				 $query1=mysql_query("select  class_name from class where class_id = '$get_id'")or die(mysql_error());
				...
				$name = $row2['class_name'];
                        ...
                        <div class="block">
                            ...
                            <h2 id="noch"> <div class="alert alert-info">Student Filter</div></h2>
                                <div class="span4">
                                        <form id="form4" name="form4" method="post" action="Admin-Process-Filter-Student">
