                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								<li><a href="#"><b>Change Profile</b></a><span class="divider"></span></li>
														</ul>
						 <!-- end breadcrumb -->
  ...
  return temp.toLowerCase();
			...
			jQuery("#change_password").submit(function(e){
					...
					$.ajax({
						...
						$.jGrowl("Your password and username is successfully change", { header: 'Change username and Password Success' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'Admin-Statistics'  }, delay);  
