        ...
        var series = [],
            options = {
                ...
                xaxis: {
                    ...
                    tickSize: null, // number or [number, "date"]
                    minTickSize: null, // number or [number, "date"]
                ...
                series: {
                    ...
                    bars: {
                        show: false,
                        lineWidth: 2, // in pixels
                        barWidth: 1, // in dates of the x axis
                        fill: true,
                        fillColor: null,
            ...
            for (i = series.length - 1; i >= 0; --i) {
                ...
                if (s.lines.show || s.points.show) {
                    for (j = 0; j < points.length; j += ps) {
                        ...
                        // data dates, because the scales of the axes may be different
