...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			oTable = $('#example').dataTable( {
				...
				"bDeferRender": true,
				"oLanguage": {
					"sLengthMenu": "date test"
				}
			} );
			oSettings = oTable.fnSettings();
		},
		function () { return oSettings.oLanguage.sLengthMenu == "date test"; }
	);
	...
	oTest.fnTest( 
		...
		null,
		function () {
			return $('label', oSettings.aanFeatures.l[0]).text() == "date test";
		}
	);
