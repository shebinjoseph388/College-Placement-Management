 ...
 *
 * criteria:
 * This is a javascript library suitable for use as a date testing framework. Employing a queuing
...
var oTest = {
	...
	/*
	 * Function: fnStart
	 * Purpose:  Indicate that this is a new date and what it is testing (message to end user)
	 * Returns:  -
	 * Inputs:   string:sMessage - message to give to the user about this date
	 */
	...
	"_fnNext": function ()
	{
		...
		{
			window.parent.controller.fndateComplete( );
		}
	},
