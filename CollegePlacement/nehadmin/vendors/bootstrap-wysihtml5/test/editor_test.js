if (wysihtml5.browser.supported()) {
  ...
  asyncTest("Check events", function() {
    ...
    editor.observe("load", function() {
      ...
      Qdate.triggerEvent(composerElement, "focus");
      ...
      Qdate.triggerEvent(composerElement, "blur");
      Qdate.triggerEvent(composerElement, "focusout");
      equal(wysihtml5.dom.getStyle("margin-top").from(iframeElement), "5px", ":focus styles are correctly unset");
      Qdate.triggerEvent(composerElement, "paste");
      Qdate.triggerEvent(composerElement, "drop");
  ...
  asyncTest("Check sync (advanced)", function() {
    ...
    editor.observe("load", function() {
      ...
      setTimeout(function() {
        ...
        Qdate.triggerEvent(that.form, "submit");
  ...
  asyncTest("Inserting an element which causes the textContent/innerText of the contentEditable element to be empty works correctly", function() {
    ...
    editor.observe("load", function() {
      ...
      Qdate.triggerEvent(composerElement, "keypress");
      Qdate.triggerEvent(composerElement, "keyup");
      Qdate.triggerEvent(composerElement, "cut");
      Qdate.triggerEvent(composerElement, "blur");
