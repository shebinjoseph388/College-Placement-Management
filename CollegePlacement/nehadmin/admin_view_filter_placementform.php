...
<?php $get_id = $_GET['id']; 
 ...
 $regno = $_GET['regno']; ?>
    ...
    <a onClick="window.open('Admin-Placementform-Excel<?php echo '?regno='.$regno?>')"  class="btn btn-success"><i class="icon-list"></i> Download Excel</a>
     <a onClick="window.open('Print-Placementform-PDF<?php echo '?regno='.$regno?>')"  class="btn btn-success"><i class="icon-list"></i> Print To PDF</a>
										<a href="Admin-Placement-Registered-Students<?php echo '?id='.$get_id?>&<?php echo 'post_id='.$post_id ?>"><i class="icon-arrow-left icon-large"></i> Back</a>
								</div>
                            </div>
