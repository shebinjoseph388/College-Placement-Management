<div class="span3" id="sidebar">
	<img id="avatar" src="nehadmin/<?php echo $row['location']; ?>" class="img-polaroid">
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class=""><a href="placement_overview_student.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;placement Overview</a></li>
				...
				<li class=""><a href="Apply-For-Placement<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp;Register Placements</a></li>
