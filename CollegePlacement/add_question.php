...
<body style = "background-image:url(nehadmin/images/index.jpg);">
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="Question-Exam<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Back</a>
								</div>
                            </div>
		...
		if ($type  == '2'){
				mysql_query("insert into quiz_question (quiz_id,question_text,date_added,answer,question_type_id,points) 
			values('$get_id','$question',NOW(),'".$_POST['correctt']."','$type','$points')")or die(mysql_error());
		}else{
	
		mysql_query("insert into quiz_question (quiz_id,question_text,date_added,answer,question_type_id,points) 
		values('$get_id','$question',NOW(),'$answer','$type','$points')")or die(mysql_error());
	...
	?>
		<script>
 		window.location = 'Question-Exam<?php echo '?id='.$get_id; ?>' 
		</script>
		<?php
		}
		?>
