...
<?php 
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class=""><a href="Student-Dashboard"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Class</a></li>
			<li class="">
			...
			<a href="Mssages-Student"><i class="icon-chevron-right"></i><i class="icon-envelope-alt"></i>&nbsp;Message
			 ...
			 <li class="active"><a href="Submit-PlacementForm"><i class="icon-chevron-right"></i><i class="icon-file"></i>&nbsp;Placement Form</a></li>
