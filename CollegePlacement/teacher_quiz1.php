                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="Add-Exam" class="btn btn-info"><i class="icon-plus-sign"></i> Add Exam</a>
									<td width="30"><a href="Add-Exam-to-Class" class="btn btn-success"><i class="icon-plus-sign"></i> Add Exam to Class</a></td>   
									</div>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td><a href="Question-Exam<?php echo '?id='.$id; ?>">Questions</a></td>                                      
                                         <td width="30"><a href="Edit-Aptitude-Exam<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>                                                                         
										</tr>
									<?php } ?>
										</tbody>
									</table>
