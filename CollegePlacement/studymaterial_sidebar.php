...
<?php 
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li ><a href="Student-List"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Students</a></li>
		<!--<li class=""><a href="add_announcement.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add Announcement</a></li> 
		<li class=""><a href="add_placement.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add Placement Criteria</a></li> -->
        <li class="active"><a href="Add-Studymaterials"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add StudyMaterials</a></li> 
		<!--<li class=""><a href="teacher_quiz.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Placement Status</a></li>-->
