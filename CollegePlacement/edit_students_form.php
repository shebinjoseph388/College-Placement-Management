       ...
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Student</a>
                        ...
                        <div class="block">
							...
							?>
                                ...
                                <div class="control-group">
										 ...
										 <!--<div class="control-group">
                                          <div class="controls">
                                            <input  name="sem"  value="<?php //echo $row['semester_id']; ?>" class="input focused" id="focusedInput" type="text" placeholder = "Semester" required>
                                          </div>
                                        </div>-->
                                        <div class="control-group">
                                          <div class="controls">
	      ...
	      <?php
                     ...
                     // $sem = $_POST['sem'];
								...
								if($count2>0){?>
									<script>
								alert(' Same CollegeID already exist for another student');
								</script>
                                <?php
								}
								else if($count3>0){
									?>
									<script>
								alert('CollegeID conflicting with Username of teacher ');
								</script>
                                <?php
								}
								else{
