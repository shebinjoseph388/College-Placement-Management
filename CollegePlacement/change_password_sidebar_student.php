...
<?php 
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class="active"><a href="Student-Dashboard"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Class</a></li>
			<li class="">
			...
			<a href="Mssages-Student"><i class="icon-chevron-right"></i><i class="icon-envelope-alt"></i>&nbsp;Message
			 ...
			 <li class=""><a href="Submit-PlacementForm"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Placement Form</a></li>
              <li><a href="PlacementForm-View"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;My Resume</a></li>
              <li ><a href="StudyMaterials"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp;Study Materials</a></li>
		</ul>
