            ...
            <div class="row-fluid">
                ...
                <div class="span4" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left"><h4> Placement Status </h4></div>
							</div>
                            <div class="block-content collapse in">
                                <div class="span12">
                              		...
                              		<?php
										...
										RIGHT JOIN placementReg on student_placementReg.placementReg_id  = placementReg.placementReg_id
										WHERE student_placementReg.student_id = '$session_id'
									...
									?>                              
										<tr>
                                         ...
                                         <td>
										 <span class="badge badge-success" ><?php echo $row['grade2']; ?></span>
										 </td>
                                         <td>
										 <span class="badge badge-success" ><?php echo $row['grade3']; ?></span>
										 </td>
										 <?php }else{ ?>
										 <td></td>
										 <?php } ?>										 
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left"><h4> Exam Result</h4></div>
							</div>
                            <div class="block-content collapse in">
                                <div class="span12">
