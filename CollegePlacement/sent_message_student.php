                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class=""><a href="Mssages-Student"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class="active"><a href="Mssages-Student-Sent"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
