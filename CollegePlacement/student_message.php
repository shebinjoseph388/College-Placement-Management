							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									$('input:checkbox').not(this).prop('checked', this.checked);
										...
										<li class="active"><a href="Mssages-Student"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class=""><a href="Mssages-Student-Sent"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
