...
<?php $get_id = $_GET['id']; 
 $back_id = $_GET['get_id'];  ?>
    ...
    <a onClick="window.open('Placementform_Excel<?php echo '?id='.$get_id?>')"  class="btn btn-success"><i class="icon-list"></i> Download Excel</a>
     <a onClick="window.open('Print-Placementform-PDF<?php echo '?id='.$get_id?>')"  class="btn btn-success"><i class="icon-list"></i> Print To PDF</a>
										<a href="MyStudents<?php echo '?id='.$back_id?>"><i class="icon-arrow-left icon-large"></i> Back</a>
								</div>
                            </div>
