...
<body style = "background-image:url(nehadmin/images/index.jpg);">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('quiz_sidebar_teacher1.php'); ?>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="add_quiz.php" class="btn btn-info"><i class="icon-plus-sign"></i> Update Status</a>
									<td width="30"><a href="add_quiz_to_class.php" class="btn btn-success"><i class="icon-plus-sign"></i> Add Status to Class</a></td>   
									</div>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td><a href="quiz_question1.php<?php echo '?id='.$id; ?>">Status</a></td>                                      
