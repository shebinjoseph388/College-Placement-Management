 ...
 ?>
    <body id="class_div" style = "background-image:url(nehadmin/images/index.jpg);">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('teacher_add_placement_sidebar.php'); ?>
...
<li><a href="#">Department: <?php echo $year_query_row['class_name']; ?></a></li>						</ul>
						 <!-- end breadcrumb -->
                        <!-- block -->
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span4">
										<form class="" id="add_downloadble" method="post" enctype="multipart/form-data" name="upload" >
                                            ...
                                            <?php
											$query = mysql_query("select * from recruitor");
											while($row = mysql_fetch_array($query))
											{
											
											?>

												<option><?php  echo $row['recruitor_name'];?></option>
                                                <?php
											}
												?>
											</select>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "add_placement_save.php",
						data: formData,
						success: function(html){
							$.jGrowl("Placement Successfully Added", { header: 'Placement Added' });
							window.location = 'add_placement.php';
						},
						cache: false,
						contentType: false,
						processData: false
