<div class="span3" id="sidebar">
	<img id="avatar" src="nehadmin/<?php echo $row['location']; ?>" class="img-polaroid">
			<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                ...
                <li class=""><a href="Filter-Students<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-info-sign"></i>&nbsp;StudentFilter</a></li>
				...
				<li class="active"><a href="Aptitude-Overview<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Exam Overview</a></li>
			</ul>
