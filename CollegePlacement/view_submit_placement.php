...
<!--<li><a href="#"><?php //echo $class_row['placement_code']; ?></a> <span class="divider">/</span></li>-->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right">
                                 <a onClick="window.open('Filter-Students<?php echo '?id='.$get_id ?>&<?php echo 'post_id='.$post_id ?>')"  class="btn btn-success"><i class="icon-list"></i>Filter</a>
                                 <a onClick="window.open('Print-Registered-Record<?php echo '?id='.$post_id?>')"  class="btn btn-success"><i class="icon-download icon-large"></i>PDF</a>
                                 <a onClick="window.open('Registered-Student-Excel<?php echo '?id='.$post_id?>')"  class="btn btn-success"><i class="icon-download icon-large"></i>Excel</a>
                                <a href="Placement-Panel<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left"></i> Back</a></div>
                            </div>
    ...
    <tbody>    
		...
		<a data-placement="top" title="Click to View all Details" id="view<?php echo $id; ?>" href="View-Filter-Student-PlacementForm<?php echo '?regno='.$regnum?>&<?php echo 'post_id='.$post_id ?>&<?php echo 'id='.$get_id ?>" class="btn btn-warning"><i class="icon-search icon-large"></i> View</a>
			<script type="text/javascript">
			$(document).ready(function(){
